    ...
    return BlocConsumer<HomeBloc, HomeState>(
      ...
      builder: (context, state) {
        ...
        return Scaffold(
          ...
          body: Container(
            child: Column(
              children: [
                ...
                //           Card(
                //             color: Colors
                //                 .blueAccent, // Set your amazing background color here
                //             elevation:
                //                 4, // Customize the shadow elevation as needed
                ...
                //         children: <Widget>[
                //           Function_Card(
                //               card_color: Colors.teal,
                //               card_icon: Icons.calendar_month,
                //               card_name: 'Calendar'),
                //           Function_Card(
                //               card_color: const Color.fromARGB(255, 79, 173, 163),
                //               card_icon: Icons.groups,
                //               card_name: 'Devlopers'),
                //           Function_Card(
                //               card_color: const Color.fromARGB(255, 79, 173, 163),
                //               card_icon: Icons.groups,
          ...
          //           ? _buildStyledIcon(Icons.home, Colors.teal)
          //           : Icon(
          //               Icons.home,
          //               size: 35.0,
          //             ),
          ...
          //           ? _buildStyledIcon(Icons.settings, Colors.teal)
          //           : Icon(
          //               Icons.settings,
          //               size: 35.0,
          //             ),
...
// Widget _buildStyledIcon(IconData iconData, Color iconColor) {
//   return Stack(
//     children: [
//       Icon(iconData, color: Colors.grey), // Inactive icon color
//       Positioned.fill(
//         child: Align(
